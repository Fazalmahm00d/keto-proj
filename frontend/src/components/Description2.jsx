function Description2(){
    return(
        <div className="flex flex-col items-center justify-center m-20 w-[60%] text-center font-light text-[#3d081bbf] text-xl  ">
            ...
            <p className="mt-6 tracking-wide">
            Our team is highly professional and <span className="font-medium"> specialized in keto low carb diet</span>, ensuring that you're getting expert advice and guidance when it comes to your meal choices. We are <span className="font-medium"> strict on our ingredients</span>strict on our ingredients and no preservatives, artificial food coloring, and restricted products are used in our food.
            </p>
            <p className="mt-6 tracking-wide">
            ...
            <div className="mt-6 ">
                <button className="bg-[#94619a] text-white p-4 uppercase font-medium text-base  rounded-full border-[#3d081b] border-0.5 shadow-[black_3px_6px_3px_0px]">
                    Explore Our Menu
                </button>
            </div>
        </div>
