  ...
  return (
    ...
    <div className="w-full md:flex-1 md:max-w-[400px]">
      <img
        src={props.data.img}
        alt={props.data.name}
        className="w-full h-[250px] md:h-full object-cover rounded-lg border-2 border-gray-200"
      />
    </div>
    ...
    <div className="flex-1 flex flex-col justify-between py-2 md:py-0">
      ...
      <p className="text-lg md:text-xl text-gray-600 mt-3 md:mt-2 flex gap-2 items-center">
