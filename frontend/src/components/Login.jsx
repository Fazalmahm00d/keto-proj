...
function Login(props) {
  ...
  return (
    <div className="min-h-screen bg-[url('./src/assets/bg2.png')] bg-center flex flex-col md:flex-row items-center justify-center gap-8 md:gap-20 px-4">
  {toast.isVisible && (
    <Toast
  ...
  <div className="p-6 text-center text-white md:w-1/2">
    <h2 className="text-3xl md:text-4xl font-bold mb-4 font-serif">Why Choose Us?</h2>
  ...
  <div className="bg-white rounded-lg shadow-xl w-full sm:w-[90%] md:w-[400px] p-6 md:p-8">
