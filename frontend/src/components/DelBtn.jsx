...
function DeleteBtnComponent(props){
    ...
    return<div>{showToast && (
        ...
        ?<div className="animate-spin rounded-full h-8 w-8 border-t-4 border-blue-500 border-solid border-gray-300"></div>
        :<button  onClick={()=>deleteHandler(props.item)}><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16">
